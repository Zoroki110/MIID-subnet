...
# Allow running this script from the repository root during manual testing.
...
def main():
    """Send a signed payload to the dataset server."""
...
if __name__ == "__main__":  # pragma: no cover - dev helper script
    main()
